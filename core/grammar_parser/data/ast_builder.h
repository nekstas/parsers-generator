...
public:
    ...
    virtual std::shared_ptr<ast::ProductionList> HandleProductionListContinue(
        std::shared_ptr<ast::ProductionList>, std::shared_ptr<ast::Production>) = 0;
    virtual std::shared_ptr<ast::Rule> HandleCommonRule(std::shared_ptr<ast::RuleHeader>,
                                                        std::shared_ptr<ast::ProductionList>) = 0;
    virtual std::shared_ptr<ast::Rule> HandleMainRule(std::shared_ptr<ast::RuleHeader>,
                                                      std::shared_ptr<ast::ProductionList>) = 0;
    ...
    virtual std::shared_ptr<ast::RuleList> HandleRuleListContinue(std::shared_ptr<ast::RuleList>,
                                                                  std::shared_ptr<ast::Rule>) = 0;
    virtual std::shared_ptr<ast::SequenceOfSymbols> HandleSequenceOfSymbolsBegin(
        std::shared_ptr<ast::TakeSymbol>) = 0;
    virtual std::shared_ptr<ast::SequenceOfSymbols> HandleSequenceOfSymbolsContinue(
        std::shared_ptr<ast::SequenceOfSymbols>, std::shared_ptr<ast::TakeSymbol>) = 0;
